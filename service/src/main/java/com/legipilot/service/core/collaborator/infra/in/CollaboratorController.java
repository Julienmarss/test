        ...
        try {
            ...
            for (Collaborator c : collaborators) {
                csvPrinter.printRecord(
                        ...
                        c.contractInformations() == null ? "" : c.contractInformations().stayType(),
                        c.contractInformations() == null ? "" : c.contractInformations().stayNumber(),
                        c.contractInformations() == null ? "" : c.contractInformations().stayValidityDate()
                );
            }
