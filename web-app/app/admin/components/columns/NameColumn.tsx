            ...
            <PopoverContent>
                <section className="flex w-40 flex-col gap-4">
                    <div className="flex items-center">
                        <Checkbox className="text-white" checked={filter === "asc"} onCheckedChange={(value) => handleChange(value as boolean, "asc")} />
                        <span className="ml-2 text-sm text-gray-700">Ordre A-Z</span>
                    </div>
                    <div className="flex items-center">
                        <Checkbox className="text-white" checked={filter === "desc"} onCheckedChange={(value) => handleChange(value as boolean, "desc")} />
