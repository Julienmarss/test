    ...
    return (
        <>
            {documents && documents.length > 0 ?
                (
                    <table className="bg-gray-50 rounded-lg w-full">
                        <tbody>
                        {documents.map((document, index) => (
                            <tr key={index}>
                                <td className="p-4 w-0 whitespace-nowrap align-middle">
                                ...
                                <td className="w-[30vw] align-middle">
                                    <span className="text-sm text-gray-900 ml-3 flex gap-x-2 items-center">
                                        {document.filename}
                                        {isPending ? (
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                 fill="currentColor" className="size-5 text-green-600">
                                                <path fillRule="evenodd"
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                             strokeWidth={1.5}
                             stroke="currentColor"
                             className="size-20 bg-sky-600 text-white mb-4 rounded-full p-2 font-semibold">
                            <path strokeLinecap="round" strokeLinejoin="round"
