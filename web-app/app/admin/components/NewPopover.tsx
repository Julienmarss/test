	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			<PopoverTrigger className="w-full">
				<Button
					className={`flex w-full items-center justify-start space-x-2 rounded-lg px-3 py-2 text-slate-300 ${open ? "bg-sky-800" : "bg-transparent"} relative transition-colors hover:bg-slate-700 hover:text-white`}
					onClick={handleOpen}
				>
					<svg
						width="18"
					...
					<div className="flex items-center gap-2">
						<div className="flex flex-col gap-1">
							<span className="text-sm md:text-justify">
								Bienvenue dans l’espace <strong>Nouveautés</strong> !<br /> Vous y trouverez toutes les dernières
								évolutions, fonctionnalités et améliorations de LégiPilot.
							</span>
