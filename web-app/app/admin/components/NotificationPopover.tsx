        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger className="w-full">
                <Button
                    ...
                    onClick={handleOpen}
                >
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="size-5 text-white" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {showBadge && !showTitle && <div className="w-[4px] h-[4px] bg-[#FF6467] rounded-full absolute top-[5px] right-[8px]" />}
                    {showTitle &&
                        <div className="flex justify-between w-full">
                            <span className="text-[16px]">Notifications</span>
                            {showBadge && <div className="bg-[#FF6467] w-[16px] h-[16px] flex items-center justify-center rounded-full">1</div>}
                        </div>
                    }
                </Button>
            </PopoverTrigger>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex gap-4">
                            <img src="/picto-legipilot.svg" alt="Logo de Legipilot" className="w-8 h-8" />
                            ...
                            <div className="flex flex-col justify-between gap-1">
                                <span className="text-sm md:text-justify">Bienvenue sur LégiPilot !<br /> Votre compte a été créé avec succès. L’onglet <strong>notifications</strong> vous accompagne au quotidien avec les rappels, échéances et actions à réaliser, pour vous guider dans votre gestion RH et juridique.</span>
