    ...
    return (
        <>
                ...
                {expandedSections.includes("etat-civil-et-situation-professionnelle") && (
                    <CardContent>
                        ...
                        <InfoField label="Ancienneté"
                            value={getSeniority(collaborator.professionalSituation?.hireDate)} />
                        ...
                        <div>
                            ...
                            <div>
                                <InfoField label="Téléphone"
                                    value={collaborator.contactDetails?.professionalPhone} />
                                <InfoField label="Email"
                                    value={collaborator.contactDetails?.professionalEmail} />
                            </div>
                        </div>
                ...
                {expandedSections.includes("coordonnees-et-situation-contractuelle") && (
                    <CardContent>
                        ...
                        <InfoField label="Classification"
                            value={collaborator.contractInformations?.classification} />
                        <InfoField label="Salaire annuel brut" isAmount={true}
                            value={collaborator.contractInformations?.annualSalary} />
                        <InfoField label="Rémunération variable" isAmount={true}
                            value={collaborator.contractInformations?.variableCompensation} />
                        <InfoField label="Avantage en nature" isAmount={true}
                            value={collaborator.contractInformations?.benefitsInKind} />
                        <InfoField label="Rémunération totale" isAmount={true}
            ...
            <Card className="border border-slate-200 rounded-xl">
                ...
                <CardContent>
                    <InfoField label="Situation familiale"
                        value={collaborator.personalSituation?.maritalStatus} />
                    <InfoField label="Enfants à charge"
                        value={collaborator.personalSituation?.numberOfChildren} />
                    <InfoField label="Niveau de diplôme"
                        value={collaborator.personalSituation?.educationLevel} />
                    <InfoField label="Permis"
                        value={collaborator.personalSituation?.drivingLicenses.join(", ")} />
            ...
            <Card className="border border-slate-200 rounded-xl">
                ...
                <CardContent
                    className="flex flex-col justify-between min-h-[17rem]"> {/* ← adapte la hauteur */}
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <a className="text-sm font-medium text-sky-700" href="mailto:marin@legipilot.com"
                            target="_blank">
                            En savoir plus
                        </a>
                    </div>
