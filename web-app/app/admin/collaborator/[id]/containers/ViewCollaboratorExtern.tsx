	...
	return (
		<>
			...
			<Card className="rounded-xl border border-slate-200">
				...
				{expandedSections.includes("etat-civil-et-informations-professionnelle") && (
					<CardContent>
						<InfoField label="Profession" value={collaborator.professionalSituation?.jobTitle} />
						<InfoField label="Date d'embauche" value={collaborator.professionalSituation?.hireDate} />
						<InfoField label="Date de fin" value={collaborator.professionalSituation?.endDate} />
			...
			<Card className="rounded-xl border border-slate-200">
				...
				{expandedSections.includes("coordonnees-et-situation-contractuelle") && (
					<CardContent>
						<InfoField label="Téléphone" value={collaborator.contactDetails?.personalPhone} />
						<InfoField label="Email" value={collaborator.contactDetails?.personalEmail} />
