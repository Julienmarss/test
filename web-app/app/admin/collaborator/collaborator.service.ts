import {
	...
	StatusResponse,
	StatusResponseCollaborator,
	WorkHoursTypeResponse,
} from "@/api/collaborator/collaborators.dto";
...
export const getCode = (nationality: string) => {
	return Object.keys(nationalities).find((key) => nationalities[key] === nationality);
};
