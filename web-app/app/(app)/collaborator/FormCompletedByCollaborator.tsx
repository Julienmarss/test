...
import { EtatCivilForm } from "@/app/(app)/admin/components/steps/EtatCivilForm";
import AddPictureProfile from "@/app/(app)/admin/components/steps/AddPictureProfile";
						...
						<div className={`flex w-full flex-row ${currentStep > 0 ? "justify-between" : "justify-end"}`}>
							<>
								...
								{currentStep < STEPS.length - 1 ? (
									...
									<ActionButton onClick={handleLastSave} disabled={disabled || isUpdatePending}>
