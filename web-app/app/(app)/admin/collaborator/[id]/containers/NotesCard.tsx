		...
		<Card className="rounded-xl border border-slate-200">
			...
			<CardContent>
				{collaborator.notes.length > 0 && (
					<div className="flex flex-col justify-between overflow-x-auto rounded-lg border border-slate-200 p-0">
						<table className="w-max md:w-full">
							<tbody>
								{collaborator.notes.map((note) => (
									<tr key={note.id} className="even:border-t even:border-slate-200 even:bg-gray-50">
										<td className="p-4">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												fill="none"
										...
										<td className="w-full">
											<div className="flex flex-col space-y-1 p-2">
												...
												<span className="whitespace-pre-line text-sm font-medium text-gray-900">{note.content}</span>
												<div className="flex items-center space-x-2">
													<span className="text-sm font-medium text-gray-500">{note.createdBy}</span>
													<span className="text-sm font-medium text-gray-500">-</span>
													<span className="text-sm font-medium text-gray-500">{note.updatedAt}</span>
												</div>
											</div>
										</td>
										<td className="pr-3">
