					...
					{expandedSections.includes("etat-civil-et-situation-professionnelle") && (
						<CardContent>
							<InfoField label="Intitulé du poste">
								<Input
									placeholder={"Saisissez l'intitulé du poste"}
							...
							<InfoField label="Type de contrat">
								<Select
									...
									options={[
										{ label: "Contrat à durée indéterminée", value: "CDI" },
							...
							<InfoField label="Ancienneté">
								<span className="text-sm text-gray-400">(Calculé automatiquement)</span>
							</InfoField>
							<InfoField label="Durée du travail">
								<div className="flex w-full flex-col gap-2">
									...
									/>
									<Select
										placeholder={"Sélectionnez la durée de travail"}
										options={[
							...
							<InfoField label="Responsable hiérarchique">
								<Input
									placeholder={"Saisissez le nom du responsable"}
							...
							<div>
								...
								<div>
									...
									<InfoField label="Adresse">
										<Input
											placeholder="Saisissez l'adresse de votre collaborateur"
					...
					{expandedSections.includes("coordonnees-et-situation-contractuelle") && (
						<CardContent>
							...
							<InfoField label="Type de titre">
								<Input
									placeholder={"Saisissez le type de titre"}
							...
							<InfoField label="Numéro de titre">
								<Input
									placeholder={"Saisissez le numéro de titre"}
