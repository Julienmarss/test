...
import { MyCollaboratorsHeader } from "@/app/(app)/admin/components/MyCollaboratorsHeader";
import { MyCollaboratorsTable } from "@/app/(app)/admin/components/MyCollaboratorsTable";
import { getFilteredCollaborators } from "@/app/(app)/admin/collaborator/collaborator.service";
import { AjouterCollaborateursModal } from "@/app/(app)/admin/components/AjouterCollaborateursModal";
...
import { useFilters } from "@/app/(app)/admin/components/table.service";
import { MyCollaboratorsTrombinoscope } from "./MyCollaboratorsTrombinoscope";
import { SelectView } from "@/app/(app)/admin/components/SelectView";
