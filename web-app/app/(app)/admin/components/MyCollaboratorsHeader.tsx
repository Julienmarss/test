...
import { SparklesSvg } from "@/app/(app)/admin/components/SparklesSvg";
...
export const MyCollaboratorsHeader = ({ searchQuery, setSearchQuery }: Props) => {
	return (
		<div className="flex min-h-96 flex-col items-center justify-center gap-8 bg-gradient-to-b from-sky-100 to-white">
			<h1 className="text-center text-2xl text-sky-950 md:text-start md:text-4xl">Rechercher un collaborateur</h1>
