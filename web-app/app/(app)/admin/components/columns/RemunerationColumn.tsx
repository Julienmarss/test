			...
			<PopoverContent>
				...
				<div className="mt-4 px-2">
					...
					>
						...
						<Slider.Thumb className="block h-4 w-4 rounded-full border border-gray-300 bg-white shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-400" />
						<Slider.Thumb className="block h-4 w-4 rounded-full border border-gray-300 bg-white shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-400" />
					</Slider.Root>
				</div>
				...
				<div className="mt-4 flex justify-between">
					<OutlineButton onClick={() => setFilter({ min: undefined, max: undefined })}>Réinitialiser</OutlineButton>
