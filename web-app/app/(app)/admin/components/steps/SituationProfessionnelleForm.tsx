		...
		>
			...
			<div className="flex flex-col gap-x-2 md:flex-row">
				<Input
					...
					placeholder={"Saisissez la date d'embauche"}
				...
				<Input
					...
					placeholder={"Saisissez la date de fin de contrat"}
			...
			<div>
				<label className={"mb-1 block w-full text-sm font-medium text-gray-900"}>Durée de travail</label>
