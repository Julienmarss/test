...
export const CoordonneesForm = ({ collaborator, handleInputChange, isFreelance }: Props) => {
	return (
		<div id="coordonnees" className="flex flex-col gap-y-2 rounded-lg border border-slate-200 bg-white p-2 md:p-6">
			...
			{!isFreelance && <span className="mt-2 text-xs text-sky-600">Coordonnées personnelles</span>}

			<div className="flex flex-col gap-x-2 md:flex-row">
				<Input
					type="tel"
					label={!isFreelance ? "Téléphone personnel" : "Téléphone"}
			...
			<Input
				placeholder={!isFreelance ? "Saisissez l'adresse de votre collaborateur" : "Saisissez l'adresse"}
				label="Adresse"
			...
			<span className="mt-2 text-xs text-sky-600">Contact d'urgence</span>
			...
			{!isFreelance && (
				<>
					<div className="mt-2 flex flex-col gap-x-2 md:flex-row">
						<Input
							type="tel"
							label="Téléphone"
							placeholder={"Ex: (+33) 6 00 00 00 00"}
					...
					<span className="mt-2 text-xs text-sky-600">Coordonnées professionnelles</span>
					...
					<span className="mt-2 text-xs text-sky-600">Coordonnées bancaires</span>
