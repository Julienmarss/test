...
export default function SignUpPage() {
	...
	const renderStepContent = () => {
		switch (currentStep) {
			...
			case 3:
				return <CreatePassword formData={formData} handleInputChange={handleInputChange} handleBack={handleBack} />;
			default:
				return null;
		}
	};
	...
	return (
		<div className="flex min-h-screen items-center gap-2 bg-sky-900 p-2">
			{/* Left Panel - Form */}
			<div className="justify-space-between flex h-[98vh] flex-1 flex-col items-start overflow-y-auto rounded-lg bg-white p-8">
				...
				{/* Step Content */}
				<div className="w-full self-center md:w-5/6">{renderStepContent()}</div>
			</div>

			{/* Right Panel - Branding */}
			<div className="right-panel h-[98vh] flex-1 content-center rounded-lg bg-slate-300 text-center">
				<div className="flex items-center justify-center space-x-4">
					<img
						src="https://legipilot-documents.s3.fr-par.scw.cloud/public/prod/visuals/Illustration-Inscription.png"
						className="h-[90vh]"
