...
export function MagicButton({
	...
	...props
}: { children: ReactNode; collaboratorSelected: UUID } & ButtonHTMLAttributes<HTMLButtonElement>) {
		...
		<>
			<Popover>
				<PopoverTrigger className="w-full">
					<Button
						variant="outline"
						className="magic-effect flex items-center space-x-2 font-medium after:bg-sky-950 hover:after:bg-sky-800"
						{...props}
					>
						<svg
				...
				<PopoverContent className="p-0">
					<div className="flex flex-col gap-3">
						<Button
							...
							className="flex gap-3 bg-transparent px-4 pt-4 hover:bg-transparent"
						...
						<Button
							...
							className="flex justify-start gap-3 bg-transparent px-4 pb-4 hover:bg-transparent"
						>
							<svg
								width="12"
								height="14"
