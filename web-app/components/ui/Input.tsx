    ...
    return (
        <div className="w-full">
            {label && label.length > 0 && (
                <label className={cn("block text-sm font-medium text-gray-900 mb-1", classNameLabel)}>
            ...
            >
                ...
                {isTel && (
                    <div className="absolute left-2 flex items-center h-full">
                        ...
                        {showCountryMenu && (
                            <div
                                className="absolute top-full left-0 mt-1 w-28 bg-white shadow-lg border rounded z-10 max-h-40 overflow-y-auto">
                ...
                <input
                    ...
                    value={value ?? ""}
                    onChange={onChange}
                    className={cn(`${baseClasses} ${borderColor} ${
                        isTel ? "pl-16" : isSearch ? "pl-8" : isAmount ? "pr-6" : ""
                    } ${isPassword || showCopy ? "pr-10" : ""}`, className)}
                />
